...
public struct SonioxAsyncClient: Sendable {
    ...
    private func createTranscription(fileId: String) async throws -> String {
        ...
        let body = SonioxAsyncClient.transcriptionRequestBody(model: SonioxConfig.asyncModel, fileId: fileId, contextTerms: contextTerms, languageHints: languageHints)
    ...
    private func url(_ path: String) throws -> URL {
        guard let u = URL(string: SonioxConfig.asyncBaseURL + path) else { throw URLError(.badURL) }
        return u
    }
